...
- **Intelligent File Categorization**: Automatically categorizes changes by type:
  ...
  - `TEST`: Test files (_\_test.go, _.spec.\*, test directories)
  - `DOC`: Documentation files (_.md, _.rst, docs/ directories)
  - `CONFIG`: Configuration files (_.yaml, _.json, .\* files, config/)
...
- Testing frameworks (_test_, _testify_, _assert_, _mock_)
