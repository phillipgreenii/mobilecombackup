...
func TestManifestValidatorImpl_LoadManifest(t *testing.T) {
	...
	err = os.WriteFile(manifestPath, manifestData, 0o600)
	if err != nil {
...
func TestManifestValidatorImpl_VerifyManifestChecksum(t *testing.T) {
	...
	err = os.WriteFile(checksumPath, []byte(checksumContent), 0o600)
	if err != nil {
	...
	err = os.WriteFile(checksumPath, []byte(wrongChecksum), 0o600)
	if err != nil {
	...
	err = os.WriteFile(checksumPath, []byte(invalidChecksum), 0o600)
	if err != nil {
