...
- **Build failures**: Verify `scripts/build-version.sh` is executable and in PATH
- **SonarQube version errors**: Check base version extraction strips `-dev` suffix correctly
